...
$(function() {
  ...
  $('#show_contacts').on('click', '.update_contact', function() {
    contact_id = 'contact_id=' + $(this).val();
    data = "contact_id=" + contact_id + ";first_name=" + $(this).closest('.first_name').val() + ";last_name=" + $(this).closest('.last_name') + ";phone_number" + $(this).closest('.phone_number') + ";address=" + $(this).closest('address');
    $.ajax({
